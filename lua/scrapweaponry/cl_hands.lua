--// All of this code dealing with hand models is from Trouble in Terrorist Town, thanks to Bad King Ugrain for putting this together

hook.Add("PlayerSetHandsModel", "scrap_hands", function( ply, ent )
	local simplemodel = TranslateToPlayerModelName(pl:GetModel())
	local info = TranslatePlayerHands(simplemodel)
	if info then
